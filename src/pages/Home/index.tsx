...
export default function Home() {
  const cards = ([
...

    {
      ...
      palestrante: 'Karam Takieddine',
      estado: 'Inscreva-se',
      start_time: '2023-09-12T23:00:00Z',
      duration: 60,
      local: 'YouTube',
      descricao: `Ut aliqua et cillum dolore deserunt aute non do occaecat duis non id. Voluptate exercitation nisi nulla eiusmod voluptate aliquip id irure aute ipsum laborum officia reprehenderit. Nulla sit proident esse velit pariatur fugiat ipsum. Reprehenderit anim cillum occaecat veniam eu est qui amet id occaecat laboris cillum ex cillum. Officia nisi velit do voluptate nostrud.`,
      linkLocal: 'https://www.youtube.com/channel/UCmbNxHgz6oJ8s8t9iwHV9Fw'
  ...
  const Patrocinadores = ([
    {
      link: 'as',
      logo: require('../../img/patrocinadores/catho.png')
    },
    {
      link: 'vv',
      logo: require('../../img/patrocinadores/catho.png')
  ...
  const visibleCards = cards.filter(card => moment(card.start_time).tz(targetTimezone).isSame(currentDateTime, 'day') );
  // const [_,setTime] = useState<Date>();
  // useEffect(() => {
    ...
    <div className="Home">
      <div className="header-container">
        <header className="header">
          ...
          <div className="header-login">
            <a className="login-link"><Link to="/gerenciarUsuarios" >Log In</Link></a>
      ...
      <section className="inicio" id="inicio">
        ...
        <div className="inicio-imagens">
          <div className="menino"><img className="imgMenino" src={menino} alt="Menino" /></div>
      ...
      <section className="palestras" id="palestras">
        <div className="container">
          <h2>Hoje teremos!</h2>
          <div className="cards">
          {
            visibleCards.map((card) => <Palestra key={card.id} talk={card}/>)
          }
          </div>
        </div>
      </section>
      <section className="quem-somos-container" id="quemSomos">
      ...
      <section className="patrocinadores" id="sectionPatrocinadores">
        <div className="containerPatrocinadores">
          <h2>Patrocinadores</h2>
          <div className="grid-patrocinadores">
            {
              Patrocinadores.map((i) => <Patrocinador key={i.link} {...i}/>)
            }
          </div>
        </div>
      </section>
